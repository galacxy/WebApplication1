...
<head id="Head1" runat="server">
    <title>
        <%# TextBox1.Text%>
        WikiSearch</title>
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:700,400' rel='stylesheet'
        type='text/css' />
...
<body>
    ...
    <br />
        <asp:Label ID="Label1" runat="server" CssClass="Header" Font-Names="Open Sans"
            Font-Size="X-Large" Font-Bold="true"></asp:Label>
        <br />
        <br />
    </div>
    <div style="margin-left: 50px; float: left; width: 100%;">
            ...
            <ItemTemplate>
                <div class='linkDiv' onclick="window.open('<%# ((KeyValuePair<string,string>)Container.DataItem).Value %>','_blank');">
                    <div class='linkDivChild'>
                        <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" Text="<%# ((KeyValuePair<string,string>)Container.DataItem).Key %>"
                            Font-Bold='true' Font-Size='Large' ForeColor='Blue' Font-Names="Open Sans" CssClass="linkstyle" />
                        <br />
